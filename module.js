...
//        var javaparams = new Array();
        ...
        /*if (appletoptions) {
            easyofischeroptions[easyofischeroptions.length] = appletoptions;
        ...
        if (readonly) {
//            easyofischeroptions[easyofischeroptions.length] = "false";  ///crl changed depict to true
//	     javaparams.menubar = "false";	    
//            easyofischeroptions[easyofischeroptions.length + 1] = "false";  ///crl changed depict to true
//	    easyofischeroptions[easyofischeroptions.length] = Y.one(topnode+' input.mol').get('value');  ///crl changed depict to true
	   // easyofischeroptions[easyofischeroptions.length] = Y.one(topnode+' input.mol').get('value');  ///crl 
...
//                Y.one(topnode+' input.mol').set('value', this.find_java_applet(name).molFile())
    ...
    show_error : function (Y, topnode) {
        var errormessage = '<span class ="javawarning">'
            +M.util.get_string('enablejava', 'qtype_easyofischer')+
            '</span>';
...
//	newApplet.setAttribute('codebase','../../../easyofischer');
