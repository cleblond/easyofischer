...
//	echo "HERE";
/**
 * The easyofischer question type.
 *
 * @copyright  1999 onwards Martin Dougiamas  {@link http://moodle.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_easyofischer extends qtype_shortanswer {
    public function extra_question_fields() {
        return array('question_easyofischer','answers', 'numofstereo', 'strictfischer');
    }
 ...
 /*   function export_to_xml( $question, qformat_xml $format, $extra=null ) {
    ...
    function import_from_xml($data, $question, qformat_xml $format, $extra=null) {
        ...
        if ($data['@']['type'] == 'easyofischer') {

            // get common parts
            $question = $format->import_headers($data);

            // header parts particular to easyofischer
            $question->qtype = 'easyofischer';
